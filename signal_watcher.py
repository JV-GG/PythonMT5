...
async def _watcher_loop() -> None:
    ...
    tracked_symbols = [s for s in SIGNALTRADE_PAIR_CODES if s in settings.allowed_symbols]

    logger.info(
        f"Signal watcher started — polling every {interval}s for symbols: {tracked_symbols}"
    )
